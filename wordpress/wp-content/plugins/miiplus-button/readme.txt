=== Plugin Name ===
Contributors: <a href="http://www.miiplus.com">peter law</a>, <a href="http://rios.co/">rios tam</a>
Donate link: http://www.miiplus.com
Tags: button, miiplus, social button, rating, feedback, like button, page, post
...
This plugin allow you to add the MiiPlus button into every post or every page of your wordpress. 

<strong>Main Features</strong>
<ul>
<li>Show the button into every pages or posts or both.</li>
<li>Show the button before or after the content.</li>
<li>Control the button show on left or right.</li>
<li>Able to disable the button on individual page or post.</li>
<li>4 modes of button to choose. (User, Love, Hate, Read)</li>
<li>8 Styles of button to choose. (Default, White, Black, Blue, Green, Grey, Red, Yellow)</li>
<li>4 Sizes of button to choose. (15px, 20px, 24px, 60px)</li>
</ul>

== Installation ==

1. Upload the plugin through Plugins > Add New > Upload interface or upload miiplus-button folder to the /wp-content/plugins/ directory.
2. Activate the plugin through the 'Plugins' menu in WordPress.
3. In the Settings section, select the MiiPlus Button and add to one of your widget areas.
4. Set the required settings and save.
...
Just grab the code <a href="http://www.miiplus.com/">here</a>
...
<mii:plus mode="love" link="yourshopurl"></mii:plus>

== Screenshots ==

1. Plugin Config screenshot
2. 60px Read button with White Style show before the post
3. 60px Read button with Grey Style show before the post
4. 24px Love button with Default Style show after the post
5. You can choose the Button you like most
